...
> Upgrading from v1? Version 2 was a breaking MUI-to-ORBIS migration — follow the [v2 migration guide](MIGRATION_V2.md) first. Version 3 keeps the v2 API; the major bump marks the switch from MIT to the Community License (see [License](#license)).
...
work without Open Design; see [BRAND_THEMING.md](BRAND_THEMING.md) for built-in
